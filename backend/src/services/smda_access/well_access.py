...
class WellAccess:
    ...
    async def get_wellbore_picks_for_wellbore(self, wellbore_uuid: str, obs_no: Optional[int] = None) -> List[WellBorePick]:
        wellbore_picks = await get_wellbore_picks_for_wellbore(
